...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Smart Energy AC',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
        primarySwatch: Colors.teal, // Anda bisa sesuaikan ini
        textTheme: GoogleFonts.poppinsTextTheme(
          // Menggunakan Google Fonts (contoh)
          Theme.of(context).textTheme,
        ),
        scaffoldBackgroundColor:
            Colors.white, // Background utama putih seperti desain
      ),
      initialRoute: '/',
      onGenerateRoute: (settings) {
        ...
        return MaterialPageRoute(
          builder: (context) =>
              autoLogin ? const DashboardLayoutScreen() : const LoginScreen(),
        );
      },
